...
WebUI.setText(findTestObject('Object Repository/Page_Sign in to Thai MOOC/input__username'), 'kentesting')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Sign in to Thai MOOC/input__password'), 'RigbBhfdqOAiM+CEI97v/A==')
...
WebUI.verifyTextPresent('Password confirmation doesn\'t match.', false)
