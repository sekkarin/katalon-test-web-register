...
WebUI.verifyTextPresent('Please specify username.', false)

WebUI.verifyTextPresent('Please specify first name.', false)

WebUI.verifyTextPresent('Please specify last name.', false)

WebUI.verifyTextPresent('Please specify email.', false)

WebUI.verifyTextPresent('Please specify password.', false)
